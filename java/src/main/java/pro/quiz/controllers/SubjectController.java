...
private final AnswerRepository answerRepository;
	...
	@PreAuthorize("hasRole('ADMIN')")
	@PutMapping("/update")
	ResponseEntity updateSubject(@RequestBody Subject subject) {
		
		
		
			Subject mySubject = this.subjectService.updateSubject(subject);
			return ResponseEntity.status(HttpStatus.OK).body(mySubject);
